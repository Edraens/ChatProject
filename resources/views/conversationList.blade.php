	...
	<table class="table table-striped table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<td class="col-xs-2"><span class="hidden-xs"><a href="/conversation/{{ $conversation->id }}"><small>{{ $lastMessage[$conversation->id]->created_at->format('d/m/Y') }}</small></a></span> <b>{{ $lastMessage[$conversation->id]->created_at->format('H:i:s') }}</b>  </td>
