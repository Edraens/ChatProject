...
<div class="container">
	<div class="row">
		<div class="col-sm-6">
			<h3><b>{{ $conv->destUser->name }}</b> <i>({{ $conv->destUser->email }})</i> <span class="pull-right"><a href="/conversation/{{ $conv->id }}" class="btn btn-success"><i class="fa fa-lg fa-refresh"></i></a></span></h3>
		</div>
		<div class="col-xs-6">
